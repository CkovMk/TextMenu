#ifndef TEXTMENU_TEST_H
#define TEXTMENU_TEST_H
#include "textmenu.h"
...
inline void MENU_DataSetupTest(menu_list_t* menu)
{
        ...
        assert(testList);
        MENU_ListInsert(menu, MENU_ItemConstruct(&menu_itemAdapter_menuType, testList, "TestList", 0, 0));
        {
            ...
            MENU_ListInsert(testList, MENU_ItemConstruct(&menu_itemAdapter_variType, &readonly_i, "readonly", 0, menuItem_data_ROFlag | menuItem_data_NoSave | menuItem_data_NoLoad));
            MENU_ListInsert(testList, MENU_ItemConstruct(&menu_itemAdapter_varfType, &longname_f, "C.M.'s Birthday", 0, menuItem_data_ROFlag | menuItem_data_NoSave | menuItem_data_NoLoad | menuItem_disp_noPreview));
            MENU_ListInsert(testList, MENU_ItemConstruct(&menu_itemAdapter_variType, &forceSciData, "forceSci", 0, menuItem_data_ROFlag | menuItem_data_NoSave | menuItem_data_NoLoad | menuItem_disp_forceSci));

        }
        MENU_ListInsert(menu, MENU_ItemConstruct(&menu_itemAdapter_procType, (void*)MENU_ExampleProcHandler1, "StrBufOvrd", 0, menuItem_proc_uiDisplay));
}

#endif // ! TEXTMENU_TEST_H
